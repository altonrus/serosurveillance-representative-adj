---
title: Evaluating the use of blood donor data for SARS-CoV-2 serological surveillance
author: 
output: 
...
Yuan Yu^1^, Matthew Knight^1^, Sheila O'Brien^2^, David L. Buckeridge^1^, W. Alton Russell^1^
...
The number of patients was `r num_patients`
